...
void switch_settings_require_oracle(void);
...
UX_STEP_CB(
  ...
  UX_STEP_CB(
    ...
    bnnn,
    switch_settings_require_oracle(),
    {
      "Oracle",
      "Require Oracle",
      "transaction data",
...
UX_FLOW(ux_warning_oracle_data_flow, &ux_warning_oracle_data_step);
